...
namespace Drone_Cargo
{
    public partial class signIn : System.Web.UI.Page
    {
        ...
        {
            // Set up informations about sign in user
            Label2.Text = _default.currentUser;
            txtName.Text = _default.currentUserInfo.Name;
            txtAddress.Text = _default.currentUserInfo.UserAddress;
            txtPhoneNumber.Text = _default.currentUserInfo.UserPhoneNumber;
            txtSurname.Text = _default.currentUserInfo.Surname;
